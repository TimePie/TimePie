...
#define SHARING_TEXT_COLOR [UIColor colorWithRed:.78 green:.78 blue:.78 alpha:1.0]
#define SHARING_TITLE_COLOR [UIColor colorWithRed:.46 green:.46 blue:.46 alpha:1]
